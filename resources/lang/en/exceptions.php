...
return [
    "backend" => [
        ...
        "relations" => [
            "already_exists" => "That Relation already exists. Please choose a different name.",
            "create_error" => "There was a problem creating this Relation. Please try again.",
            "delete_error" => "There was a problem deleting this Relation. Please try again.",
            "not_found" => "That Relation does not exist.",
            "update_error" => "There was a problem updating this Relation. Please try again.",
        ],
    ],
    "frontend" => [
        "auth" => [
            "confirmation" => [
                ...
                "resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://enterprise.ex/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
