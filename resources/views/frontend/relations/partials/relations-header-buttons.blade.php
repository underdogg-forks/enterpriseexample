<!--Action Button-->
@if( Active::checkUriPattern( 'admin/relations' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'frontend.relations.relations.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.frontend.relations.all' ) }}
            </a>
        </li>
        @permission( 'create-relation' )
        <li>
            <a href="{{ route( 'frontend.relations.relations.create' ) }}">
                <i class="fa fa-plus"></i> {{ trans( 'menus.frontend.relations.create' ) }}
            </a>
        </li>
        @endauth
    </ul>
