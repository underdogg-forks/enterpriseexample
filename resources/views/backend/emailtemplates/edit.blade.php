    ...
    <div class="box box-info">
        ...
        <div class="box-body">
                ...
                <div class="col-lg-10">
                    <div class="input-group box-size">
                        ...
                        <span class="input-group-btn">
                                <button class="btn btn-primary" id="addPlaceHolder"
                                        type="button">{{ trans('buttons.general.crud.add') }}</button>
                            </span>
                    </div><!-- /input-group -->
                </div><!--col-lg-10-->
            </div><!--form control-->
            ...
            <div class="edit-form-btn">
                ...
                <input type="button" id="showPreview" data-toggle="modal" data-target="#templatePreview"
                       class="btn btn-info btn-md" value="{{ trans('buttons.general.preview') }}"/>
