...
@section ('title', trans('labels.backend.relations.management'))

@section('page-header')
    <h1>{{ trans('labels.backend.relations.management') }}</h1>
@endsection

@section('content')
    <div class="box box-info">
        <div class="box-header with-border">
            <h3 class="box-title">{{ trans('labels.backend.relations.management') }}</h3>
        ...
        <div class="box-body">
            <div class="table-responsive data-table-wrapper">
                <table id="relations-table" class="table table-condensed table-hover table-bordered">
                    <thead>
                    <tr>
                        <th>{{ trans('labels.backend.relations.table.id') }}</th>
                        <th>{{ trans('labels.backend.relations.table.name') }}</th>
                        <th>{{ trans('labels.backend.relations.table.createdat') }}</th>
                        <th>{{ trans('labels.backend.relations.table.updatedat') }}</th>
