<!--Action Button-->
@if( Active::checkUriPattern( 'backendadmin/relations' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'frontend.relations.relations.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.relations.all' ) }}
            </a>
        </li>
        @permission( 'create-relation' )
        <li>
            <a href="{{ route( 'admin.relations.create' ) }}">
                <i class="fa fa-plus"></i> {{ trans( 'menus.backend.relations.create' ) }}
            </a>
        </li>
        @endauth
    </ul>
